.. _rucdev.ix.ix_interfaces_module:
...
**Resource module to configure interface.**
...
Synopsis
--------
- This module manages the interface attributes of Nec Univerge IX network devices.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>This command doesn&#x27;t limit bandwidth on interface.</div>
                        <div>The bandwidth is used calculate for MIB or cost.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Full name of interface, like GigaEthernet1.1</div>
                </td>
            </tr>
