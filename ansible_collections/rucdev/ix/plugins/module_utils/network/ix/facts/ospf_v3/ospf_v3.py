...
from ansible_collections.rucdev.ix.plugins.module_utils.network.ix.rm_templates.ospf_v3 import (
    Ospf_v3Template,
)
...
class Ospf_v3Facts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        # parse native config using the Ospf_v3 template
