...
"""
The module file for ix_ospf_v3
"""
...
from ansible_collections.rucdev.ix.plugins.module_utils.network.ix.argspec.ospf_v3.ospf_v3 import (
    Ospf_v3Args,
)
from ansible_collections.rucdev.ix.plugins.module_utils.network.ix.config.ospf_v3.ospf_v3 import (
    Ospf_v3,
)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=Ospf_v3Args.argument_spec,
    ...
    result = Ospf_v3(module).execute_module()
